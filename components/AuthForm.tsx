    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (error.message.includes('already exists')) {
          setError('This email is already registered.Choose another one or please sign in instead.');
        } 
      ...
      <header className="flex flex-col gap-5 md:gap-8">
        <Link href="/" className="cursor-pointer flex items-center gap-1">
          <Image 
            ...
            alt="Volt Bank logo"
          />
          <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">Volt Bank</h1>
        </Link>
        ...
        <>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              {/* Email & Password (Both Sign Up and Sign In) */}
              <CustomInput
                control={form.control}
                name="email"
                label="Email"
